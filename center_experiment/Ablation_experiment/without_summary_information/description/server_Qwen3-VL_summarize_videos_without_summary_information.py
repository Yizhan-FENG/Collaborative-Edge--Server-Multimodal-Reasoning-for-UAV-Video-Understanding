...
# 1. 定义多视频的输入路径
# 结构化文本文件（包含所有视频的报告）
MULTI_VIDEO_REPORTS_PATH = "/data3/health/wyy/BLIP2/experiment/data/msrvtt/structured_reports/without_summary_videos_analysis_results_human_readable_20260326_145436.txt"
# 关键帧图片的基础目录（每个视频有独立的子文件夹）
KEYFRAMES_BASE_DIR = "/data3/health/wyy/BLIP2/experiment/data/msrvtt/keyframes"
# 输出目录
OUTPUT_BASE_DIR = "/data3/health/wyy/BLIP2/experiment/Ablation_experiment/without_summary_information/description/qwen3_vl_results"
