...
# 多视频输入路径
# 结构化文本文件（包含所有视频的报告）
MULTI_VIDEO_REPORTS_PATH = "/data3/health/wyy/BLIP2/final/main_path/edge_output_videos/msvd-qa/structured_reports/without_summary_videos_analysis_results_human_readable_20260408_164854.txt"
...
# 输出目录
OUTPUT_BASE_DIR = "/data3/health/wyy/BLIP2/final/main_path/experiment/Ablation_experiment/without_summary_information/QA/qwen3_vl_results"
...
1.  You must use the input keyframe image as the sole visual truth anchor to verify, correct, and refine the accompanying BLIP2 structured text. Directly copying text content without validating visual information is strictly prohibited.
